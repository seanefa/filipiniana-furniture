                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['phaseStatus']=="Active"){
                                  echo('<td>'.$row['phaseName'].'</td>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-success" data-toggle="modal" href="phases-forms.php" data-remote="phases-forms.php?id=<?php echo $row['phaseID']?> #update" data-target="#myModal"><span class='glyphicon glyphicon-edit'></span> Update</button>
                                      <!-- DELETE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="phases-forms.php" data-remote="phases-forms.php?id=<?php echo $row['phaseID']?> #delete" data-target="#myModal"><span class='glyphicon glyphicon-trash'></span> Deactivate</button>
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
