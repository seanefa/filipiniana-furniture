                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['f_patternStatus']!="Listed"){
                                  echo('<tr>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Fabric+Pattern&amp;id=<?php echo $row['f_patternID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>'); }}?>
