...
if($flag>0){
	if(mysqli_query($conn,$action)){
		$selectemail = "SELECT * from tblcustomer a, tblorders b WHERE b.custOrderID = a.customerID and b.orderID = '$id'";
		...
		while($row = mysqli_fetch_assoc($res)){
			...
			$orderNumber = str_pad($row['orderID'], 6, '0', STR_PAD_LEFT);
...
// HTML email starts here
			...
			<p style='font-size:18px; text-align:center;'> Your order has been rejected for some reason</p>
			<p style='font-size:18px; font-family:Verdana, Geneva, sans-serif;'>Please be informed that your Order#" . $orderNumber . " has been rejected, please see details below for more information.</p>
...
//echo 'Mailer Error: ' . $mail->ErrorInfo;
				...
				echo '<script>
				alert("Order Request successfully rejected!");
				window.location.href = "dashboard.php";
				</script>';
			}
		}
