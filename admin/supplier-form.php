    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="updateJobModal" aria-hidden="true" style="display: none;">
      <div class="modal-dialog modal-lg">
        <div class="modal-content" id="update">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 class="modal-title" id="modalProduct">Update Supplier</h3>
          </div>
              ...
              <div class="descriptions">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                     <label class="control-label">Company Name</label> <span id="x" style="color:red"> *</span>
                      <input type="text" id="edit1" onkeyup="updateValidate('1')" class="form-control" value="<?php echo $trow['supCompName']?>" name="compname" required><span id="messageName"></span>
                    </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="control-label">Company Address</label><span id="x" style="color:red"> *</span>
                      <input type="text" id="edit2" onkeyup="updateValidate('2')" class="form-control" value="<?php echo $trow['supCompAdd']?>" name="compadd" required><span id="messageAddress"></span>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="control-label">Contact Number</label><span id="x" style="color:red"> *</span>
                      <input type="text" id="editNumber" data-mask="+63 (999) 999-9999" class="form-control" value="<?php echo $trow['supCompNum']?>" name="telnum" required><span id="messageNumber"></span>
                    </div>
                  </div>
                </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="control-label">Contact Person</label><span id="x" style="color:red"> *</span>
                      <input type="text" id="edit3" onkeyup="updateValidate('3')" class="form-control" value="<?php echo $trow['supContactPerson']?>" name="conper" required><span id="messagePerson"></span>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="control-label">Position</label><span id="x" style="color:red"> *</span>
                      <input type="text" id="edit4" onkeyup="updateValidate('4')" class="form-control" value="<?php echo $trow['supPosition']?>" name="posi" required><span id="messagePosition"></span>
                    </div>
                  </div>
                </div>
