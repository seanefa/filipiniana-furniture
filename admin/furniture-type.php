          ...
          <div class="panel panel-info">
            <h3>
              <ul class="nav customtab2 nav-tabs" role="tablist">
                ...
                <a id="temptitle" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"></span><span class="hidden-xs"></span><i class="ti-layout-media-center"></i>&nbsp;<span id="archiveTitle" style="display: none;">Archived</span>&nbsp;<?php echo $titlePage?></a>
              </li>
            </ul>
          </h3>
                        ...
                        <div id="archiveTable">
                          <div class="table-responsive"> 
                            <table class="table color-bordered-table muted-bordered-table dataTable display">
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['typeStatus']=="Archived"){
                                  $cat = categoryName($row['typeCategoryID']);
                                  echo('<tr><td>'.$row['typeName'].'</td><td>'.$cat.'</td>
                                    <td>'.$row['typeDescription'].'</td>
                                    ');?>
                                    <td>
                                        <button type="button" class="btn btn-danger" data-toggle="modal" href="reactivate-form.php" data-remote="reactivate-form.php?rName=Type&amp;id=<?php echo $row['typeID']?> #reactivate" data-target="#myModal"><i class="ti-reload"></i> Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
