                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['typeStatus']=="Listed"){
                                  ...
                                  echo('<tr><td>'.$row['typeName'].'</td><td>'.$cat.'</td>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-success" data-toggle="modal" href="furn-type-form.php" data-remote="furn-type-form.php?id=<?php echo $row['typeID']?> #update" data-target="#myModal"><span class='glyphicon glyphicon-edit'></span> Update</button>
                                      <!-- DELETE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="furn-type-form.php" data-remote="furn-type-form.php?id=<?php echo $row['typeID']?> #delete" data-target="#myModal"><span class='glyphicon glyphicon-trash'></span> Deactivate</button>
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
