            ...
            <h3>
              <ul class="nav customtab2 nav-tabs" role="tablist">
                <li role="presentation" class="active">
                  <a id="temptitle" href="#packages" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"></span><span class="hidden-xs"></span><i id="ti" class="ti-archive"></i>&nbsp;<?php echo $titlePage?></a>
                </li>
              </ul>
            </h3>
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="table-responsive">
                          ...
                          <thead>
                            <tr>
                              <th style="text-align: left;">Package Description</th>
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                ...
                                if($row['packageStatus']!="Listed"){
                                  echo ('<td>'.$row['packageDescription'].'</td>
                                    ...
                                    <td>
                                      <!-- VIEW -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Packages&amp;id=<?php echo $row['packageID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
