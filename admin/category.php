                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['categoryStatus']=="Listed"){
                                  echo('<td>'.$row['categoryName'].'</td>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-success" data-toggle="modal" href="category-form.php" data-remote="category-form.php?id=<?php echo $row['categoryID']?> #update" data-target="#myModal"><i class='ti-pencil-alt'></i> Update</button>
                                      <!-- DELETE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="category-form.php" data-remote="category-form.php?id=<?php echo $row['categoryID']?> #delete" data-target="#myModal"><i class='ti-close'></i> Deactivate</button>
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
                        ...
                        <div id="archiveTable">
                          <div class="table-responsive"> 
                            <table class="table color-bordered-table muted-bordered-table dataTable display">
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['categoryStatus']=="Archived"){
                                  echo('<td>'.$row['categoryName'].'</td>
                                    <td>'.$row['categoryRemarks'].'</td>
                                    ');?>
                                    <td>
                                        <button type="button" class="btn btn-danger" data-toggle="modal" href="reactivate-form.php" data-remote="reactivate-form.php?rName=Category&amp;id=<?php echo $row['categoryID']?> #reactivate" data-target="#myModal"><i class="ti-reload"></i> Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
