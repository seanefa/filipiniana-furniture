...
$sql3 = "SELECT * FROM tblmat_var WHERE mat_varID = '$name';";
$result3 = mysqli_query($conn,$sql3);
$row3 = mysqli_fetch_array($result3);
$matVar = $row3['mat_varDescription'];
$matID = $row3['materialID'];

$sql2 = "SELECT * FROM tblmaterials WHERE materialID = '$matID';";
...
echo "<tr id='trowID' class='materialNeed'>
      ...
      <input type='hidden' class='form-control' id='matvar' name='matvarid[]' value='". $name ."' />
      </td>
      <td>
...
//       <input type='hidden' class='form-control' id='matvar' name='matvar[]' value='". $matVar ."' />
//       <input type='hidden' class='form-control' id='matvar' name='matvarid[]' value='". $name ."' />
//       <input type='hidden' class='form-control' id='matdesc' name='matdesc[]' value='". $matVar ." / ". $matName ."' />
//       </td>
//       <td>
//       <input type='text' class='col-lg-4' maxlength='5' size='5' id='matquan' style='text-align:right;' name='matquan[]' value='". $quan ."'/>
//       </td>";
