          ...
          <div class="panel panel-info">
            <h3>
              <ul class="nav customtab2 nav-tabs" role="tablist">
                ...
                <a id="temptitle" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"></span><span class="hidden-xs"></span><i class="ti-slice"></i>&nbsp;<span id="archiveTitle" style="display: none;">Archived</span>&nbsp;<?php echo $titlePage?></a>
              </li>
            </ul>
          </h3>
                            ...
                            <table class="table color-bordered-table muted-bordered-table dataTable display">
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['materialStatus']=="Archived"){
                                  ...
                                  <td>'.$row['materialRemarks'].'</td>'); ?>
                                  <td>
                                        <button type="button" class="btn btn-danger" data-toggle="modal" href="reactivate-form.php" data-remote="reactivate-form.php?rName=Frame+Material&amp;id=<?php echo $row['materialID']?> #reactivate" data-target="#myModal"><i class="ti-reload"></i> Reactivate</button> 
