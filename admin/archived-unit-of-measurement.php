                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['unStatus']=="Archived"){
                                  echo('<tr>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Unit+of+Measure&amp;id=<?php echo $row['unID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>'); }}?>
