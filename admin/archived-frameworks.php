          ...
          <div class="panel panel-info">
            <h3>
              ...
              <li role="presentation" class="active">
                  <a id="temptitle" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs"></span><i class="ti-archive"></i>&nbsp;<?php echo $titlePage?></a>
                </li>
              </ul>
            </h3>
                          ...
                          <tbody style="text-align: left;">
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['frameworkStatus']!="Listed"){
                                  ...
                                  <td>
                                  <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Framework&amp;id=<?php echo $row['frameworkID']?> #react" data-target="#myModal">Reactivate</button> 
                                  </td>
                                  <?php echo('</tr>');} }
                                  ?>
