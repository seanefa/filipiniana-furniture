                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="username" class="form-control" name="ctgName" maxlength="45" required><span id="message"></span>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="control-label">Name</label><span id="x" style="color:red"> *</span>
                      <input type="text" id="editname" class="form-control" placeholder="Name" name="name" value="<?php echo $trow['categoryName']; $_SESSION['tempname'] = $trow['categoryName'];?>" maxlength="45" required><span id="message"></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12 ">
                    <div class="form-group">
                      <textarea class="form-control" rows="4" id="remText" name="remarks"><?php echo $trow['categoryRemarks'];?></textarea>
                    </div>
                  </div>
                </div>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="deleteCategoryModal" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content" id="delete">
        ...
        <div class="modal-footer">
          <a href="delete-category.php?id=<?php echo $jsID;?>" type="button" role="button" class="btn btn-danger waves-effect text-left">Confirm</a>
