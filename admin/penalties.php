            ...
            <h3>
              <ul class="nav customtab2 nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active">
                  <a id="temptitle" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"></span><span class="hidden-xs"></span><i class="ti-alert"></i>&nbsp;<?php echo $titlePage?></a>
                </li>
              </ul>
            </h3>
              <!-- DELIVERY RATES -->
                  ...
                  <div class="panel-body">                    
                    <div class="row">
                      <div class="table-responsive">
                        <table class="table color-bordered-table muted-bordered-table dataTable display nowrap" id="tblPenalties">
                          <thead>
                            <tr>
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['penStatus']=="Active"){
                                  echo('<tr><td>'.$row['penaltyName'].'</td>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal" href="penalty-form.php" data-remote="penalty-form.php?id=<?php echo $row['penaltyID'];?> #update">Update</button>
                                      <!-- DELETE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal" href="penalty-form.php" data-remote="penalty-form.php?id=<?php echo $row['penaltyID'];?> #delete">Deactivate</button>
                                    </td>
                                    <?php echo('</tr>');} }
                                    ?>
