                          ...
                          <tbody style="text-align: left;">
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['materialStatus']!="Listed"){
                                  ...
                                  <td>
                                    <!-- UPDATE -->
                                    <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Frame+Material&amp;id=<?php echo $row['materialID']?> #react" data-target="#myModal">Reactivate</button> 
                                  </td>
                                  <?php echo('</tr>');} }
                                  ?>
