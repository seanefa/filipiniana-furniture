                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['matTypeStatus']!="Listed"){
                                  echo('<td>'.$row['matTypeName'].'</td>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Material+Type&amp;id=<?php echo $row['matTypeID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
