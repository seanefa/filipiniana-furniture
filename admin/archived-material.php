                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['materialStatus']!="Listed"){
                                  echo('<td>'.$row['materialName'].'</td>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Material&amp;id=<?php echo $row['materialID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
