...
?>
<body>
  <!-- New Default Downpayment Modal -->
  <div class="modal fade" tabindex="-1" role="dialog" id="newDefaultDownpaymentModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" id="new">
        ...
        <form name="form1" action="add-default-downpayment.php" method="post">
      ...
      <!-- /.modal -->
      <!-- Update Default Downpayment Modal -->
      <div class="modal fade" tabindex="-1" role="dialog" id="updateDefaultDownpaymentModal" aria-hidden="true">
        <div class="modal-dialog">
          ...
          <!-- /.modal -->
          <!-- Delete Default Downpayment Modal -->
          <div class="modal fade" tabindex="-1" role="dialog" id="deleteDefaultDownpaymentModal" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content" id="delete">
                ...
                <div class="modal-footer">
                  <a href="delete-default-downpayment.php?id=<?php echo $jsID;?>" type="button" role="button" class="btn btn-danger waves-effect text-left">Confirm</a>
