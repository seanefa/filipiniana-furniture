                              ...
                              <div class="panel-body">
                                ...
                                <div class="row" id="allprod">
                                  ...
                                  <div class="row formScroll" id = "tblProd">
                                    ...
                                    $sql = "SELECT * FROM tblorders WHERE orderStatus!='Ready for release' AND orderStatus!='Archived' AND orderStatus!='Rejected' AND orderStatus!='finished' AND orderStatus!='WFA' AND orderType!='On-Hand' order by orderID;";
