          ...
          <div class="panel panel-info">
            <h3>
              <ul class="nav customtab2 nav-tabs" role="tablist">
                <button id="tempbtn" class="btn btn-lg btn-info pull-right" data-toggle="modal" href="prod-form.php" data-remote="production-materials-form.php #new" data-target="#myModal" aria-expanded="false" style="margin-right: 20px;"><span class="btn-label"><i class="ti-plus"></i></span>New</button>
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                ...
                                if($row['prodStat']=="Pre-Order"){
                                  ...
                                  echo('<td>'. $row['typeName'] .'</td>
                                    ...
                                    ');?>
                                    <td><button type="button" class="btn btn-info" data-toggle="modal" href="production-materials-form.php" data-remote="production-materials-form.php?id=<?php echo $row['productID']?> #update" data-target="#myModal">View Materials</button></td>
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-success" data-toggle="modal" href="production-materials-form.php" data-remote="production-materials-form.php?id=<?php echo $row['productID']?> #update" data-target="#myModal">Update</button>
                                      <!-- DELETE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="production-materials-form.php" data-remote="production-materials-form.php?id=<?php echo $row['productID']?> #delete" data-target="#myModal">Deactivate</button>
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
