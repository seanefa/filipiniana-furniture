                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['categoryStatus']!="Listed"){
                                  echo('<td>'.$row['categoryName'].'</td>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Category&amp;id=<?php echo $row['categoryID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
