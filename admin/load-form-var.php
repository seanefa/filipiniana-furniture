 ...
 $query1 = mysqli_query($conn,$selectdata1);
	...
	if($row1['uncategoryID']==0){
	 echo '<input type="text" id="attribb" class="form-control" name="desc['.$i.']" required><input type="number" id="attribb" class="form-control hide" name="uncID['.$i.']" value="'.$row1['uncategoryID'].'"><br>';
			...
			echo '<input type="number" id="attribb" class="form-control hide" name="categorycounter" value="'.$x.'"><input type="number" id="attribb" class="form-control" name="uvalue['.$i.']['.$x.']" placeholder="'.$row1['uncategoryName'].'" required><input type="number" id="attribb" class="form-control hide" name="uncID['.$i.']['.$x.']" value="'.$row1['uncategoryID'].'"><br><select class="form-control" tabindex="1" name="unid['.$i.']['.$x.']" id="unid" required>';
