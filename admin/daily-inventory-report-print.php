...
<body>
  <div>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div style="text-align: center;">
          <p style="text-align: center; font-family: inherit; font-weight: bolder; font-size: 20px;">- DAILY INVENTORY REPORT -</p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div style="text-align: center;">
          ...
          $inventoryReportID = "DailyInventoryReport". $orderID;?></span>
        </div>
      </div>
    </div>
