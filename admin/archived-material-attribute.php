                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['attributeStatus']=="Archived"){
                                  echo('<tr>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Material+Attribute&amp;id=<?php echo $row['attributeID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>'); }}?>
                                  ...
                                  <script type="text/javascript">
                                    function confirmDelete(id) {
                                      if (confirm("Are you sure you want to delete")) {
                                        window.location.href="delete-material-attribute.php?id="+id+"";
                                      }
                                    }
                                    function edit(id) {
                                      window.location.href="update-material-attribute.php?id="+id+"";
                                    }
                                  </script>
                                </tbody>
                              </table>
