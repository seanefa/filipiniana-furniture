                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['prodStat']!="On-Hand"){
                                  ...
                                  echo('<td>'. $row['typeName'] .'</td>
                                    ...
                                    <td>
                                      <!-- VIEW -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Product&amp;id=<?php echo $row['productID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo ('</tr>');
                                  }
                                }
