    ...
    <div class="modal-content" id="update">
      ...
      <form action="prod-info-update.php" method = "post">
        <div class="modal-body">
          <div class="descriptions">
            <?php
            $sql1 = "SELECT * FROM tblprod_info a, tblproduct b, tblfurn_type c, tblfurn_category d WHERE a.prodInfoProduct = b.productID and b.prodTypeID = c.typeID and d.categoryID = b.prodCatID and a.prodInfoID = '$jsID'";
            ...
            <div class="form-body">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="control-label">Category</label><span id="x" style="color:red"> *</span>
                    <select class="form-control" data-placeholder="Choose a Category" tabindex="1" name="cat" id="cat" disabled>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label class="control-label">Phase</label><span id="x" style="color:red"> *</span>
                <select class="form-control" tabindex="1" name="phase" disabled>
                  <?php
                  include "dbconnect.php";
                  $sql = "SELECT * FROM tblphases order by phaseName;";
                  $result = mysqli_query($conn, $sql);
                    ...
                    <div class="table-responsive">
                      <table class="table color-bordered-table muted-bordered-table dataTable display nowrap" id="selectedMaterials">
                        <thead>
                          ...
                          <tbody  id="tblMat" style="text-align: left;">
                            <?php
                            $sql = "SELECT * FROM tblprod_materials a, tblprod_info b, tblmaterials c, tblmat_var d, tblmat_type e WHERE a.p_prodInfoID = b.prodInfoID and a.p_matDescID = d.mat_varID and d.materialID = c.materialID and e.matTypeID = c.materialType and b.prodInfoID = '$jsID';";
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                              if($row['p_matStatus']!="Archived"){
                                ...
                                <td><input type='hidden' class='form-control' id='exist".$row['p_matID']."' name='existRec[]' value='". $row['materialID'] ."'/>". $row['mat_varDescription'].'/'.$row['materialName']."</td>"."
                                <input type='hidden' class='form-control' name='mat_var[]' value='". $row['mat_varID'] ."' />
                                </td>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="viewProductModal" aria-hidden="true" style="display: none;">
    ...
    <div class="modal-dialog modal-lg" >
      <div class="modal-content" id="view1">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h3 class="modal-title">View Materials </h3>
        </div>
        <?php
              ...
              <div class="row">
                ...
                <div class="row" style="margin:20px;">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="control-label">Phase</label><span id="x" style="color:red"> *</span>
                      <select class="form-control" tabindex="1" name="phase" id="phase" disabled>
                        <?php
                        include "dbconnect.php";
