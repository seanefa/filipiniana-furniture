                  ...
                  <div class="panel-body">              
                    <div class="row">
                      <div class="table-responsive">
                          ...
                          <thead>
                            <tr>
                              <th style="text-align: left;">Branch(From:)</th>
                              ...
                              while ($row = mysqli_fetch_assoc($result))
                              {
                                if($row['delRateStatus']!="Listed"){
                                  ...
                                  echo('<tr><td>'.$branch.'</td>
                                    ...
                                    <td>
                                      <!-- UPDATE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Delivery+Rate&amp;id=<?php echo $row['delivery_rateID']?> #react" data-target="#myModal">Reactivate</button> 
                                    </td>
                                    <?php echo('</tr>');} }
                                    function bName($id){
                                      include "dbconnect.php";
