                          ...
                          <tbody style="text-align: left;">
                            ...
                            while ($row = mysqli_fetch_assoc($result))
                            {
                              ...
                              if($row['variantStatus']=="Archived"){
                                ...
                                <td>
                                <!-- UPDATE -->
                                      <button type="button" class="btn btn-danger" data-toggle="modal" href="react-form.php" data-remote="react-form.php?rName=Material+Variants&amp;id=<?php echo $row['variantID']?> #react" data-target="#myModal">Reactivate</button> 
                                </td>
                                <?php echo('</tr>');} }
                                function desc($id){
                                  include "dbconnect.php";
