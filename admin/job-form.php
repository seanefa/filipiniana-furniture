                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                     <label class="control-label">Name</label> <span id="x" style="color:red"> *</span>
                      <input type="text" id="username" maxlength="45" class="form-control" name="name" required><span id="message"></span>
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="form-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="control-label">Name</label><span id="x" style="color:red"> *</span>
                        <input type="text" id="editname" maxlength="45" class="form-control" placeholder="Name" name="name" value="<?php echo $trow['jobName']; $_SESSION['tempname'] = $trow['jobName'];?>" required><span id="message"></span>
                      </div>
                    </div>
                  </div>
                  <div class="row">
