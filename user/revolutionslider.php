    ...
    <div id="slider1" class="rev_slider"  data-version="5.0">
      <ul>
        <li data-transition="random">
          <!-- MAIN IMAGE -->
          <img src="image/slider/revslider/gold-vector.jpg"  alt=""  width="1349" height="480">
          <!-- LAYER NR. 1 -->
	 ...
	 style="z-index: 9;
	 	background-color:#e5e5e5;"> </div>
          ...
          <div class="tp-caption NotGeneric-Title tp-resizeme" 
									...
									style="z-index: 6; white-space: nowrap; font-family:inherit;">END OF </div>
          <!-- LAYER NR. 4 -->
          <div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme" 
	 ...
	 style="z-index: 9;
	 	background-color:#e5e5e5;"> </div>
          ...
          <div class="tp-caption NotGeneric-Title tp-resizeme" 
									...
									data-responsive_offset="on" 
									data-elementdelay="0.05" 
									style="z-index: 6; white-space: nowrap; font-family:inherit;">SEASON SALE </div>
          <!-- LAYER NR. 6 -->
          <div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme" 
	 ...
	 style="z-index: 9;
	 	background-color:#e5e5e5;"> </div>
          ...
          <div class="tp-caption NotGeneric-Title tp-resizeme" 
									...
									style="z-index: 6; white-space: nowrap; font-family:inherit;">UP TO 20% OFF </div>
          <!-- LAYER NR. 8 -->
          <div class="tp-caption WebProduct-Button rev-btn rs-parallaxlevel-0" 
									...
									style="z-index: 14; white-space: nowrap; font-family:inherit;">SHOP NOW </div>
        </li>
        <li data-transition="random">
          <!-- MAIN IMAGE -->
        ...
        <li data-transition="random">
          <!-- MAIN IMAGE -->
          <img src="image/slider/revslider/03minimalist-banner.jpg"  alt=""  width="1349" height="480">
          <!-- LAYER NR. 1 -->
          <!--div class="tp-caption NotGeneric-SubTitle tp-resizeme rs-parallaxlevel-0" 
									 id="slide-3-layer-1" 
									 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
          ...
          <div class="tp-caption NotGeneric-SubTitle tp-resizeme rs-parallaxlevel-0" 
									 id="slide-3-layer-3" 
									 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
									 data-y="['middle','middle','middle','middle']" data-voffset="['-30','70','70','31']"
                                     data-fontsize="['28','28','28','20']"
                                     data-lineheight="['28','28','28','22']" 
                                     data-fontweight="700"
									data-width="none"
          ...
          <div class="tp-caption WebProduct-Button rev-btn rs-parallaxlevel-0" 
									 id="slide-3-layer-4" 
									 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                                     data-y="['middle','middle','middle','middle']" data-voffset="['30','110','110','31']"
									data-width="['auto']"
									data-height="['auto']"
									data-whitespace="nowrap"
									data-transform_idle="o:1;"
