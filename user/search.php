          ...
          <div class="product-filter">
            <div class="row">
              <div class="col-md-4 col-sm-5">
                ...
                <a href="compare.php" id="compare-total">Product Compare (0)</a> </div>
          ...
          <div class="row products-category">
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/macbook_pro_1-270x405.jpg" alt=" Strategies for Acquiring Your Own Laptop " title=" Strategies for Acquiring Your Own Laptop " class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php"> Strategies for Acquiring Your Own Laptop </a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/nikon_d300_1-270x405.jpg" alt="Digital Camera for Elderly" title="Digital Camera for Elderly" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">Digital Camera for Elderly</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/FinePix-Long-Zoom-Camera-270x405.jpg" alt="FinePix S8400W Long Zoom Camera" title="FinePix S8400W Long Zoom Camera" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">FinePix S8400W Long Zoom Camera</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/ipod_shuffle_1-270x405.jpg" alt="Hp Pavilion G6 2314ax Notebok Laptop" title="Hp Pavilion G6 2314ax Notebok Laptop" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">Hp Pavilion G6 2314ax Notebok Laptop</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/palm_treo_pro_1-270x405.jpg" alt="HTC M7 with Stunning Looks" title="HTC M7 with Stunning Looks" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">HTC M7 with Stunning Looks</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/macbook_1-270x405.jpg" alt="Ideapad Yoga 13-59341124 Laptop" title="Ideapad Yoga 13-59341124 Laptop" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">Ideapad Yoga 13-59341124 Laptop</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/iphone_1-270x405.jpg" alt="iPhone5" title="iPhone5" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">iPhone5</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/macbook_air_1-270x405.jpg" alt="Laptop Silver black" title="Laptop Silver black" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">Laptop Silver black</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/ipod_nano_1-270x405.jpg" alt="Mp3 Player" title="Mp3 Player" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">Mp3 Player</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/ipod_classic_1-270x405.jpg" alt="Portable Mp3 Player" title="Portable Mp3 Player" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">Portable Mp3 Player</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/ipod_touch_1-270x405.jpg" alt="Samsung Galaxy S4" title="Samsung Galaxy S4" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">Samsung Galaxy S4</a></h4>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                <div class="image"><a href="product.php"><img src="image/product/samsung_tab_1-270x405.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop" class="img-responsive" /></a></div>
                <div>
                  <div class="caption">
                    <h4><a href="product.php">Aspire Ultrabook Laptop</a></h4>
