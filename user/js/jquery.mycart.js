...
(function ($) {
  ...
  var loadMyCartEvent = function(targetSelector){
    ...
    '</table>' +
        ...
        '<button type="button" id="checkoutBtn" onclick="checkLog()" class="btn btn-primary">Checkout</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td class="text-center" style="width: 30px;"><a href="view-product.php?id='+this.id+'"><img width="80px" height="100px" src="' + this.image + '"/></a></td>' +
          '<td><a href="view-product.php?id='+this.id+'">' + this.name + '</a></td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td id="ttq"></td><input type="hidden" id="totalQuant" value=""/>' +
        '<td><strong id="' + idGrandTotal + '"></strong><input type="hidden" id="totalGrand" value=""/></td>' +
        '<td></td>' +
        '</tr>'
