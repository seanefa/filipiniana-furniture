      ...
      <div class="row">
        ...
        <aside id="column-left" class="col-sm-3 hidden-xs">
          ...
          <div class="box-category">
            <ul id="cat_accordion">
              <li><a href="products.php">Product</a> <span class="down"></span>
                <ul>
                  <li><a href="products.php">Sub Categories</a> <span class="down"></span>
                    <ul>
                      <li><a href="products.php">New Sub Categories</a></li>
                      <li><a href="products.php">New Sub Categories</a></li>
                      <li><a href="products.php">New Sub Categories</a></li>
                      <li><a href="products.php">New Sub Categories</a></li>
                      <li><a href="products.php">New Sub Categories</a></li>
                  ...
                  <li><a href="products.php">Sub Categories</a></li>
                  <li><a href="products.php">Sub Categories</a> <span class="down"></span>
                    <ul>
                      <li><a href="products.php">New Sub Categories</a></li>
                      <li><a href="products.php">New Sub Categories</a></li>
          ...
          <div class="side-item">
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/apple_cinema_30-50x75.jpg" alt="Product" title="Product" class="img-responsive" /></a></div>
              <div class="caption">
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/iphone_1-50x75.jpg" alt="Product" title="Product" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/macbook_1-50x75.jpg" alt="Product" title="Product" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/sony_vaio_1-50x75.jpg" alt="Product" title="Product" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/FinePix-Long-Zoom-Camera-50x75.jpg" alt="Product" title="Product" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
          ...
          <div class="side-item">
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/macbook_pro_1-50x75.jpg" alt=" Product " title=" Product " class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/samsung_tab_1-50x75.jpg" alt="Product" title="Product" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/nikon_d300_1-50x75.jpg" alt="Product" title="Product" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/nikon_d300_5-50x75.jpg" alt="Product" title="Product" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/macbook_air_1-50x75.jpg" alt="Laptop Silver black" title="Laptop Silver black" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Product</a></h4>
        ...
        <div id="content" class="col-sm-9">
          ...
          <ul class="list-item">
                ...
                <div class="col-sm-3">
          <ul class="list-item">
                        <li><a href="products.php">Category (0)</a></li>
                        <li><a href="products.php">Category (0)</a></li>
                      </ul>
        </div>
                      </div>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                ...
                <div>
                  <div class="caption">
                    <h4><a href="view-product.php"> Product </a></h4>
                    <p class="description">Product 5</p>
                    <p class="price"> <span class="price-new">&#8369 1,400.00</span> <span class="price-old">&#8369 1,900.00</span> <span class="saving">-26%</span> <span class="price-tax">Ex Tax: &#8369 1,400.00</span> </p>
                  </div>
            ...
            <div class="product-layout product-list col-xs-12">
              <div class="product-thumb">
                ...
                <div>
                  <div class="caption">
                    <h4><a href="view-product.php">Product</a></h4>
                    <p class="description">Product 7</p>
                    <p class="price"> <span class="price-new">&#8369 92.00</span> <span class="price-old">&#8369 98.00</span> <span class="saving">-6%</span> <span class="price-tax">Ex Tax: &#8369 75.00</span> </p>
                  </div>
                  <div class="button-group">
