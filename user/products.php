              ...
              <?php
                ...
                while ($row = mysqli_fetch_assoc($result)){
                  ...
                  if($row['prodStat'] != "Archived"){
                    ...
                    <div class="image"><a href="view-product.php"><img style="height:405px; width:270;" src="../admin/plugins/images/'.$row['prodMainPic'].'" alt="Product" class="img-responsive" onerror="productImgError(this);"/></a></div>
                    <br>
                    <div class="caption">
