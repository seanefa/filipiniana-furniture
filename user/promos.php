      ...
      <div class="row">
        ...
        <aside id="column-left" class="col-sm-3 hidden-xs">
          ...
          <div class="box-category">
            <ul id="cat_accordion">
              <li><a href="products.php">Promo</a> <span class="down"></span>
                <ul>
          ...
          <div class="side-item">
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/apple_cinema_30-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/iphone_1-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Promo</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/macbook_1-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Promo</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/sony_vaio_1-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Promo</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/FinePix-Long-Zoom-Camera-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Promo</a></h4>
          ...
          <div class="side-item">
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/macbook_pro_1-50x75.jpg" alt=" Promo " title=" Promo " class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Promo</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/samsung_tab_1-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Promo</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/apple_cinema_30-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="http://demo.harnishdesign.net/opencart/marketshop/v1/index.php?route=product/product&amp;product_id=42">Promo</a></h4>
                <p class="price"> <span class="price-new">&#8369 110.00</span> <span class="price-old">&#8369 122.00</span> <span class="saving">-10%</span> </p>
              </div>
            </div>
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/nikon_d300_1-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Promo</a></h4>
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="view-product.php"><img src="image/product/nikon_d300_5-50x75.jpg" alt="Promo" title="Promo" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="view-product.php">Promo</a></h4>
