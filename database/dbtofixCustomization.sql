...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2017 at 02:52 PM
...
CREATE TABLE `tblcompany_info` (
  ...
  `comp_emailPassword` varchar(45) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tblcompany_info` (`comp_recID`, `comp_logo`, `comp_name`, `comp_num`, `comp_email`, `comp_address`, `comp_about`, `comp_emailPassword`) VALUES
(1, 'filipiniana-furniture-logo.png', 'Filipiniana Furnitures', '(046) 417 8418', 'filfurnitures@gmail.com', 'Aguinaldo Hi-way, Talaba II, Bacoor, Cavite', 'A furniture shop', 'filfurnitures01');
...
(43, 'Mariano', 'Sapico', 'Lozano', 'caloocan', '12312312', 'znotsukaima@gmail.com', 'defaultdp.jpg', 1, 'active');
...
(1, 18, 'A blue furniture', 'WFA', '2017-10-15'),
(6, 43, 'asdasds', 'WFA', '2017-12-15');
...
(4, 6, 'black and white dining set.jpg'),
(5, 6, 'Blue.jpg'),
(6, 6, 'BrownCouch.jpg');
...
ALTER TABLE `tblcustomize_request`
  ...
  ADD KEY `tblcustomID` (`tblcustomerID`);
...
--
ALTER TABLE `tblcustomize_request`
  ADD CONSTRAINT `tblcustomize_request_ibfk_1` FOREIGN KEY (`tblcustomerID`) REFERENCES `tblcustomer` (`customerID`);
